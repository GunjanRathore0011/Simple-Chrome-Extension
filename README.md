...
Note: This repository was upgraded from Manifest V2 to Manifest V3. The popup now uses the `chrome.scripting` API. To load and test the extension, follow the same steps above in recent Chrome/Chromium builds that support Manifest V3.
